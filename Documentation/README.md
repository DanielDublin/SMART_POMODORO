When downloading the project, do note you have to replace the constants at secrets.h with the firebase data.
Buttons:
...
[Uploading User_Setup.h…](//                            USER DEFINED SETTINGS
