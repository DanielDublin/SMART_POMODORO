...
class _DaySummaryScreenState extends State<DaySummaryScreen> {
  ...
  Future<Map<String, dynamic>> _fetchDayData() async {
    ...
    final logs = List<Map<String, dynamic>>.from(logsSnap.docs.map((doc) => doc.data()));
    ...
    final completionPercentage = expectedMinutes > 0 ? (actualMinutes / expectedMinutes * 100).clamp(0, 100) : 0;
  ...
  Future<void> _updateSessionTime(String logId, DateTime newStartTime, DateTime newEndTime) async {
    final duration = newEndTime.difference(newStartTime).inMinutes;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'Sessions for ${DateFormat('EEEE, MMMM d, yyyy').format(widget.selectedDate)}',
                        ...
                        children: [
                          ...
                          ClipRRect(
                            ...
                            child: LinearProgressIndicator(
                              minHeight: 10,
                              value: expectedMinutes > 0 ? (actualMinutes / expectedMinutes).clamp(0, 1) : 0,
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    OutlinedButton.icon(
                                                      ...
                                                      label: Text(DateFormat('hh:mm a').format(startTime), style: TextStyle(fontSize: 15)),
                                                    ),
                                                  ],
                                                ),
                                              ),
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    OutlinedButton.icon(
                                                      ...
                                                      icon: Icon(Icons.access_time, size: 18),
                                                      label: Text(DateFormat('hh:mm a').format(endTime), style: TextStyle(fontSize: 15)),
                                                    ),
                                                  ],
                                                ),
                                              ),
